...
class BonCaisseController extends Controller
{
    ...
    public function createAvance(Request $request)
    {
        try {
            ...
            // Créez et sauvegardez le bon de caisse de type "avance"
            ...
            $avance->user_id = 1; // Utilisez l'ID de l'utilisateur connecté
    ...
    public function createAutres(Request $request)
    {
        try {
            ...
            // Créez et sauvegardez le bon de caisse de type "autres"
    ...
    public function show($date_emission, $beneficiaire_id)
    {
        try {
            ...
            // Gérer l'exception ici
            return response()->json(['error' => 'Une erreur est survenue lors de la recherche des bons de caisse.'], 500);
        }
    }
